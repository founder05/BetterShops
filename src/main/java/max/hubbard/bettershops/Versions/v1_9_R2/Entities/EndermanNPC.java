...
public class EndermanNPC extends EntityEnderman {
    public EndermanNPC(World world) {
        ...
        goalC.clear();
        List<?> targetB =
            (List<?>) getPrivateField("b", PathfinderGoalSelector.class, targetSelector);
        targetB.clear();
        List<?> targetC =
            (List<?>) getPrivateField("c", PathfinderGoalSelector.class, targetSelector);
        targetC.clear();
    ...
    public static Object getPrivateField(String fieldName, Class<PathfinderGoalSelector> clazz,
        Object object) {
    ...
    public static Enderman spawn(Location location) {
        ...
        final EndermanNPC customEntity = new EndermanNPC(world);
        customEntity
    ...
    @Override public double e(double d0, double d1, double d2) {
        return 0;
    }
    ...
    @Override public boolean k(double x, double y, double z) {
        return false;
    }
