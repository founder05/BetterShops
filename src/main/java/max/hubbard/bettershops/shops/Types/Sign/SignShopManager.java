...
public class SignShopManager {
    ...
    private static final HashMap<Sign, Material> signs = new HashMap<>();
    private static final HashMap<Sign, Double> prices = new HashMap<>();
    private static final HashMap<Sign, Integer> amts = new HashMap<>();
    private static final HashMap<Sign, UUID> ids = new HashMap<>();
    private static final HashMap<Sign, Boolean> sell = new HashMap<>();
    private static final HashMap<Sign, Boolean> admin = new HashMap<>();
    private static final HashMap<Sign, Chest> chests = new HashMap<>();
    private static final HashMap<Sign, ItemStack> items = new HashMap<>();
    private static final HashMap<Inventory, Sign> invs = new HashMap<>();
                        ...
                        if (lines.length == 4 && lines[0] != null && lines[1] != null && lines[2] != null && lines[3] != null) {
                            if (lines[0].length() == 15 && lines[1].length() == 15 && lines[2].length() > 2 && lines[3].contains(":")) {
                                ...
                                if (p.hasPlayedBefore()) {
                                    ...
                                    String mat = lines[2].substring(3);
