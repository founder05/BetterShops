        ...
        try {
                ...
                for (String l : lore) {
                    ...
                    if (caa) {
                        ...
                        if (cl.getSimpleName().equals("Type") && e == EntityType.OCELOT) {
                            ...
                            if (l.contains(Language.getString("NPCs", cl.getSimpleName()))) {
                                obj = l.substring(
                                    Language.getString("NPCs", cl.getSimpleName()).length() + 3);
                            }
                        }
                        if (cl.isEnum()) {
            ...
            if (e == EntityType.SHEEP) {
                entity.getClass().getMethod("setSheared", boolean.class)
                    .invoke(entity, info.isSheared());
            }
            if (e == EntityType.ZOMBIE) {
                entity.getClass().getMethod("setVillager", boolean.class)
                    .invoke(entity, info.isVillagerZombie());
