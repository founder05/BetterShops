...
public class ClickableItem {
    ...
    private final List<LeftClickAction> lcActions = new ArrayList<LeftClickAction>();
    private final List<RightClickAction> rcActions = new ArrayList<RightClickAction>();
    private final List<ShiftClickAction> sActions = new ArrayList<ShiftClickAction>();

    private final ShopItemStack item;
