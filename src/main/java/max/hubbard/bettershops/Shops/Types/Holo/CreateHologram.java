...
public class CreateHologram {
    ...
    public static void removeShopChest(final Shop shop) {
        new BukkitRunnable() {
            ...
            @Override
            public void run() {
                if (shop.getLocation().getBlock().getRelative(1, 0, 0).getType() == XMaterial.OAK_WALL_SIGN.parseMaterial()) {
                ...
                if (shop.getLocation().getBlock().getRelative(0, 0, 1).getType() ==  XMaterial.OAK_WALL_SIGN.parseMaterial()) {
