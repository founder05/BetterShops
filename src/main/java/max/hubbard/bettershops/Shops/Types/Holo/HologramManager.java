...
public class HologramManager {
    private static final List<ShopHologram> holos = new ArrayList<>();

    private static final HashMap<Shop,ShopHologram> shopHolos = new HashMap<>();
    ...
    private static final HashMap<Shop,ShopIcon> shopIcons = new HashMap<>();
