package max.hubbard.bettershops.configuration.ConfigMenu;
...
public class ConfigMenu {
    ...
    public static void openConfigMenu(Inventory inv, Player p, int page) {
        ...
        for (int i = j; i < k; i++) {
            ...
            if (!s.contains("database") && !s.contains("database") && !s.contains("Version") && !s
                .contains("user") && !s.contains("host") && !s.contains("pass") && !s
                .contains("root") && !s.contains("port")) {
