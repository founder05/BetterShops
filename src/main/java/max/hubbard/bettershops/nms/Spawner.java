        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if (type != EntityType.PLAYER) {
                    try {
                        Class.forName("max.hubbard.bettershops.nms." + version + ".Register")
                            .getMethod("registerNPCs").invoke(null);
                        ref.set((LivingEntity) Class.forName(
                            "max.hubbard.bettershops.nms." + version + ".Entities." + npc + "NPC")
                            .getMethod("spawn", loc[0].getClass()).invoke(null, loc[0]));
                        Class.forName("max.hubbard.bettershops.nms." + version + ".Register")
                            .getMethod("unregisterNPCs").invoke(null);
                    ...
                    try {
                        ...
                        ref.set((LivingEntity) Class.forName(
                            "max.hubbard.bettershops.nms." + version + ".Entities." + npc + "NPC")
                            .getMethod("spawn", loc[0].getClass(), loc[1].getClass())
                            .invoke(null, loc[0], loc[1]));
                        Class.forName("max.hubbard.bettershops.nms." + version + ".Register")
                            .getMethod("unregisterNPCs").invoke(null);
